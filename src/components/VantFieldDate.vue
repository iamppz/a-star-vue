<template>
    <div class="vant-field-date">
        <van-field :label="label" :value="value" :placeholder="placeholder" @click="showPop = true"></van-field>
        <van-popup v-model="showPop" :label="label" position="bottom" :overlay="true">
            <van-datetime-picker v-bind="$attrs" :value="currentDate" :type="type" title="请选择日期" @cancel="cancel"
